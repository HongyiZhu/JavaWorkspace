...
public class ShopinfoDAO implements DAO{
	public String getTableName() { return "shopinfo"; }
//	public String getTypeNamespace() { return type_namespace.divide(Define.type_namespace_gain).toString(); }
	public String getTypeNamespace() { return ""; }
...
//	}
	...
	public int getisTmall() {return isTmall;}
	...
	public String[] insert() {
		...
		command[0] = "insert into `shopinfo` " +
				"(`shopURL`,`userID`,`isTmall`,`hasList`, `isDone`)" +
				" values " +
				"( "+ ValueTransfer.SqlValueFor(url) +", "+ ValueTransfer.SqlValueFor(userID) + ", "+ ValueTransfer.SqlValueFor(isTmall) +
				", "+ ValueTransfer.SqlValueFor(hasList) +", "+ ValueTransfer.SqlValueFor(isDone) +")";
		return command;
	}
	...
	public String[] delete(String website_namespace, String start_ID,
			String end_ID) {
//		BigInteger namespace = new BigInteger(website_namespace).multiply(new BigInteger("10000000000000000")).add(ShopinfoDAO.type_namespace);
