...
public class Test {
	...
	void testUserTianmijiayuanInsert(){
		...
		try{
			ut.configure("usertianmijiayuan.com", "101", "19");
	...
	void testArticleInsert(){
		...
		try{
			...
			a.configure("article.com", "101", "45");
	...
	void testVideoInsert(){
		...
		try{
			...
			v.configure("video.com", "101", "34");
			v.setPosition(null, null);
			v.setMetadata(null, "1990-1-1", null, null, null, null, "wokao");
			op.insert(v);
			op.emptyCache();
		}catch(SQLException e){
			e.printStackTrace();
	...
	void testUserBaidutiebaInsert(){
		...
		try{
			ut.configure("baidutieba.com", "101", "19");
	...
	void testUser39doctorInsert(){
		...
		try{
			ut.configure("user39doctor.com", "110", "19");
			ut.setUrl("tian.com/haha");
			ut.setName("nihao");
			ut.setBaseInfo(null, -1, null, null, null);
